...
export const metadata: Metadata = {
  title: "카이멘토 — 세종 KAIST 수업과 월 2회 학부모님 상담",
  description: "세종 전용 KAIST 수학·과학 1:1 수업과 카이멘토의 월 2회 학부모님 전화 상담. 선생님 연결 이후에도 학습 상황을 확인하고 필요한 조정을 함께합니다.",
};
  ...
  return <div className="min-h-screen bg-white text-slate-950"><MarketingHeader /><main>
    <section className="border-b border-slate-100"><div className="mx-auto grid max-w-[1440px] lg:grid-cols-[47%_53%]">
      <div className="flex flex-col justify-center px-5 py-10 sm:px-8 sm:py-14 lg:px-16">
        ...
        <p className="mt-6 text-base leading-8 text-slate-600">KAIST 선생님과의 1:1 수업과<br />월 2회 학부모님 전화 상담을 함께 제공합니다.</p>
        <p className="mt-5 flex w-fit items-center gap-2 rounded-xl bg-blue-50 px-4 py-3 text-sm font-bold text-blue-600"><MarketingIcon className="h-5 w-5 shrink-0" />카이멘토 · 월 2회 · 학부모님 전화 상담</p>
      ...
      <div className="relative min-h-[380px] bg-slate-100 sm:min-h-[480px] lg:min-h-[620px]">
        ...
        <div className="absolute bottom-12 right-4 ml-4 flex items-center gap-3 rounded-2xl bg-white/95 px-5 py-5 shadow-lg sm:right-8"><span className="text-blue-600"><MarketingIcon /></span><div><p className="text-sm font-bold sm:text-base">학부모님 상담은 <span className="text-blue-600">카이멘토에서</span></p><p className="mt-2 text-xs leading-5 text-slate-600">월 2회, 수업 이후까지 함께 살펴드립니다.</p></div></div>
