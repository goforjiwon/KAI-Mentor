...
function joinWeekdays(values: string[]) {
  return join(sortByOptionOrder(values, WEEKDAYS));
}

function joinApplicationSubjects(values: string[]) {
  return join(sortByOptionOrder(values, APPLICATION_SUBJECTS));
}

function joinChildPersonalities(values: string[]) {
  return join(sortByOptionOrder(values, CHILD_PERSONALITIES));
}
